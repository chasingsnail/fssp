...
(function(mod) {
  ...
  function maybeUpdateLineNumberWidth(cm) {
    ...
    if (last.length != display.lineNumChars) {
      ...
      display.lineNumInnerWidth = Math.max(innerW, display.lineGutter.offsetWidth - padding)+5;//+5临时解决兼容IE11小版本折叠问题
  ...
  function updateLineGutter(cm, lineView, lineN, dims) {
    ...
    if (cm.options.lineNumbers || markers) {
      ...
      var gutterWrap = lineView.gutter =
        wrap.insertBefore(elt("div", null, "CodeMirror-gutter-wrapper", "left: " + (cm.options.fixedGutter ? dims.fixedPos : -dims.gutterTotalWidth) + "px; width: " + dims.gutterTotalWidth + "px"), lineView.text);
