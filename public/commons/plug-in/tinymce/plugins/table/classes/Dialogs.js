...
define("tinymce/tableplugin/Dialogs", [
	...
	return function(editor) {
		...
		self.table = function(isProps) {
			...
			function onSubmitTableForm() {
				...
				editor.undoManager.transact(function() {
					...
					//修改代码添加ID属性
					editor.dom.setAttrib(tableElm, 'id', data.id);
			...
			if (isProps === true) {
				...
				if (tableElm) {
					...
					//修改代码添加Id属性
					data.id= dom.getAttrib(tableElm,"id");
		...
		self.cell = function() {
			...
			function onSubmitCellForm() {
				...
				editor.undoManager.transact(function() {
					each(cells, function(cellElm) {
						...
						//修改代码添加ID属性
						editor.dom.setAttrib(cellElm, 'id', data.id);
			...
			//修改代码添加Id属性
			data.id= dom.getAttrib(cellElm,"id");
		...
		self.row = function() {
			...
			function onSubmitRowForm() {
				...
				editor.undoManager.transact(function() {
					...
					each(rows, function(rowElm) {
						...
						//修改代码添加ID属性
						editor.dom.setAttrib(rowElm, 'id', data.id);
			...
			//修改代码添加Id属性
			data.id= dom.getAttrib(rowElm,"id");
