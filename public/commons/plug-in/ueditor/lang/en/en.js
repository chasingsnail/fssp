...
UE.I18N['en'] = {
    ...
    'networkimage':{
        'static':{
            'lang_tab_remote':"Insert picture", //节点
            'lang_input_url':"Address：",
            'lang_input_size':"Size：",
            'lang_input_width':"Width",
            'lang_input_height':"Height",
            ...
            'lang_input_title':"Desc：",
            'lang_input_align':'float mode：',
            'lang_imgLoading':"Picture loading...",
            'lock':{'title':"Lock aspect ratio"}, //属性
            'noneAlign':{'title':'None'},
            'leftAlign':{'title':'Left'},
            'rightAlign':{'title':'Right'},
            'centerAlign':{'title':'The middle one row'}
        },
        'uploadTurnLeft':'Turn to the left',
        'uploadTurnRight':'Turn to the right',
        'uploadPreview':'Preview',
        'uploadNoPreview':'Cannot Preview',
        'updateStatusReady': 'Select _ pictures, _KB。',
        'updateStatusConfirm': '_ has successfully uploaded photos, _ photo upload failed',
        'updateStatusFinish': 'A total of _ Zhang (_KB), Zhang _ uploaded successfully',
        'remoteLockError':"The height is not correct and the ratio can not be locked.",
        'imageUrlError':"Not allowed picture format or image domain!",
        'imageLoadError':"Image loading failed! Please check the link address or network status!",
        'searchLoading':"Picture loading, later...",
        'searchRetry':" :(, Sorry, no picture! Please try again!"
    },
    'attachment':{
        'static':{
