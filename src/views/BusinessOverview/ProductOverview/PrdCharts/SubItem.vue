<template>
  <div class="inner-wrap">
    <div class="item-inner" :class="{right: rightSide}">
...
.item-inner {
  ...
  .icon-uncheck {
    ...
    width: 48px;
    height: 48px;
    background: url('../../../../assets/images/icon_service_unsel@2x.png') no-repeat center;
  ...
  .icon-active {
    ...
    width: 40px;
    height: 40px;
    background: url('../../../../assets/images/icon_service_sel@2x.png') no-repeat center;
